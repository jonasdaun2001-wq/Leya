...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <h2>💌 Meine Liebe</h2>
            <p>Liebe Leya,</p>
            <p>diese Website ist ein kleiner Beweis dafür, wie viel du mir bedeutest. Jeden Tag mit dir ist ein Geschenk, und ich wollte dir auf eine besondere Art zeigen, wie sehr ich dich liebe.</p>
            <p>Du bringst Licht in meine dunkelsten Tage, lässt mich lachen wenn ich traurig bin, und machst jeden Moment zu etwas Besonderem.</p>
            <p>Ich liebe dich mehr als Worte es je ausdrücken könnten! ❤️</p>
    ...
    <script>
        ...
        function valentineAnswer(answer) {
            ...
            if (answer === 'yes') {
                responseDiv.innerHTML = '🎉 Yay! Du hast mich zum glücklichsten Menschen gemacht! ❤️❤️❤️<br><br>Ich liebe dich so sehr! 💕';
